      ...
      <main className="flex-1 lg:ml-64 min-w-0">
        ...
        <div className="px-6 py-8 max-w-xl space-y-4">
                ...
                {provisionError ? (
                  ...
                  <div className="flex items-center gap-3 bg-[#0D0D0D] border border-[#333333] rounded-sm px-4 py-2.5">
                    ...
                    <span className="font-inter text-sm text-[#555555]">
                      {provisioning ? 'Provisioning your stream…' : 'Stream key unavailable — check Mux credentials in Vercel'}
                    </span>
                  </div>
                ) : (
                  <div className="flex items-center gap-2">
          ...
          <p className="font-inter text-sm text-[#555555] px-1">
            Once you start streaming, members can watch live on MATPEAK.
            The stream status above updates automatically.
          </p>

  ...
  return (
    <div className="min-h-screen bg-[#0D0D0D] p-6">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="h-8 w-48 bg-[#222222] rounded animate-pulse" />
        <div className="h-10 w-10 bg-[#222222] rounded-full animate-pulse" />
      </div>
          ...
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="bg-[#111] border border-white/5 rounded-sm overflow-hidden">
              ...
              <div className="p-3">
                ...
                <div className="h-3 w-1/2 bg-[#222222] rounded animate-pulse" />
              </div>
            </div>
          ))}
        </div>

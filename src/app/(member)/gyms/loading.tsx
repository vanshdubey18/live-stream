export default function GymsLoading() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] p-6">
      {/* Search bar skeleton */}
      <div className="h-11 w-full max-w-lg bg-[#1a1a1a] rounded-xl animate-pulse mb-6" />
      ...
      <div className="flex gap-2 flex-wrap mb-8">
        {Array.from({ length: 8 }).map((_, i) => (
          <div
            key={i}
            className="h-8 bg-[#1a1a1a] rounded-full animate-pulse"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="bg-[#111] border border-white/5 rounded-xl overflow-hidden">
            ...
            <div className="p-4">
              <div className="h-5 w-3/4 bg-[#1a1a1a] rounded animate-pulse mb-2" />

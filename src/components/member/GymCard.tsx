  ...
  return (
    <div className="bg-[#1A1A1A] border border-white/5 rounded-2xl p-6 hover:border-white/10 transition-all duration-200 flex flex-col gap-4">
      ...
      <div className="flex items-start justify-between">
        <div>
          <div className="w-10 h-10 rounded-xl bg-[#FF3B3B]/20 flex items-center justify-center mb-3">
      ...
      {/* Next class */}
      <div className="flex items-center gap-2 bg-[#0D0D0D] rounded-xl px-4 py-3">

...
export default function ReplayCard({
  ...
  return (
    <div className="bg-[#111111] border border-white/5 rounded-2xl overflow-hidden hover:border-white/10 transition-all duration-200 group flex-shrink-0 w-64">
      {/* Thumbnail */}
      <div className={`relative h-36 bg-gradient-to-br ${disciplineGradients[discipline] ?? 'from-gray-900/40 to-gray-800/20'} flex items-center justify-center`}>
        <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-[#DC2626]/80 transition-all duration-200">
      ...
      <div className="p-4">
        ...
        <p className="text-[#888888] text-xs">{coach} · {gym}</p>
        ...
        <a
          href="#"
          className="mt-3 w-full flex items-center justify-center gap-1.5 border border-white/10 hover:border-[#DC2626]/40 hover:bg-[#DC2626]/5 text-white text-xs font-semibold py-2 rounded-xl transition-all duration-200"
        >
